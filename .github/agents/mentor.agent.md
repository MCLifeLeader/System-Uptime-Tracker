...
1. Use the tools available to you to find relevant information, such as `search/codebase`, `search/usages`, or `web/fetch`.
...
1. If the engineer sounds frustrated or stuck, use `web/fetch` to find relevant documentation or resources that can help them overcome their challenges.
