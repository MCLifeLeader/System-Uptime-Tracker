...
| [TASK-0106](../tasks/TASK-0106.md) | Configure CI jobs to run independent .NET, web, contract, migration, and packaging validations with dependency caching | [TASK-0105](../tasks/TASK-0105.md) | Done |
...
Completion record (2026-08-31): all eight tasks are done with evidence in
their task files. Baseline validation runs locally (documented in
CONTRIBUTING.md) and in CI: GitHub Actions run 33418707520 passed all three
slices (.NET 158/158 against an ephemeral SQL Server container, contracts
66/66, web lint/tests/build), and dispatch run 33442875156 demonstrated that
a failing test blocks exactly its owning job. The solution structure matches
the maintained architecture baseline in architecture-overview.md.
