...
| [TASK-0702](../tasks/TASK-0702.md) | Implement atomic first-run `AgentId` creation and load with corrupt-file handling and an OS-supplied durable-state path | [TASK-0701](../tasks/TASK-0701.md) | Not started |
...
| [TASK-0706](../tasks/TASK-0706.md) | Implement bootstrap login, protected refresh-token storage, proactive access-token refresh, and disabled/revoked response handling | [TASK-0702](../tasks/TASK-0702.md), [TASK-0404](../tasks/TASK-0404.md) | Not started |
