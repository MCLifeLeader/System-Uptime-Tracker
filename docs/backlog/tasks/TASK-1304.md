---
id: TASK-1304
title: 'Queue and publish normalized readings with their own message IDs and retry classification'
type: task
status: not-started
epic: EPIC-13
release_gate: 'Gate 3'
depends_on: ['TASK-0806', 'TASK-1303']
unblocks: ['TASK-1308']
---

# TASK-1304: Queue and publish normalized readings with their own message IDs and retry classification

## Objective

Queue and publish normalized readings with their own message IDs and retry classification.
...
- Outage recovery sends each reading exactly once logically while retaining measured time.
