---
id: TASK-1206
title: 'Preserve optional raw vendor payload only under an explicit size, redaction, and retention policy'
type: task
status: not-started
epic: EPIC-12
release_gate: 'Gate 3'
depends_on: ['TASK-1205']
unblocks: []
---

# TASK-1206: Preserve optional raw vendor payload only under an explicit size, redaction, and retention policy

## Objective

Preserve optional raw vendor payload only under an explicit size, redaction, and retention policy.
...
- Tests prevent credentials and unbounded payloads from entering `RawPayload`.
