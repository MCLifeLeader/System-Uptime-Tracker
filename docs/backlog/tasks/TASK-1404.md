---
id: TASK-1404
title: 'Write start, stop, status, logs, configuration, credential rotation, queue diagnosis, upgrade, rollback, uninstall, and state-recovery runbooks for both agents'
type: task
status: not-started
epic: EPIC-14
release_gate: 'Gate 3'
depends_on: ['TASK-0909', 'TASK-1007']
unblocks: ['TASK-1408']
---

# TASK-1404: Write start, stop, status, logs, configuration, credential rotation, queue diagnosis, upgrade, rollback, uninstall, and state-recovery runbooks for both agents

## Objective

Write start, stop, status, logs, configuration, credential rotation, queue diagnosis, upgrade, rollback, uninstall, and state-recovery runbooks for both agents.
...
- An operator unfamiliar with the code completes a disposable-host lifecycle using the runbook.
