---
id: TASK-1305
title: 'Implement `Location`, `MonitoredDevice`, `MachinePowerMeterAssociation`, `PowerMeterDeviceAssociation`, and `PowerMeterLocationHistory` with effective dates'
type: task
status: not-started
epic: EPIC-13
release_gate: 'Gate 3'
depends_on: ['TASK-1203']
unblocks: ['TASK-1306']
---

# TASK-1305: Implement `Location`, `MonitoredDevice`, `MachinePowerMeterAssociation`, `PowerMeterDeviceAssociation`, and `PowerMeterLocationHistory` with effective dates

## Objective

Implement `Location`, `MonitoredDevice`, `MachinePowerMeterAssociation`, `PowerMeterDeviceAssociation`, and `PowerMeterLocationHistory` with effective dates.
...
- EF model and migration tests match domain relationships and preserve independent creation.
