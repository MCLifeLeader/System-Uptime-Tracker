---
id: TASK-1201
title: 'Implement `PowerMeter` and `PowerReading` entities, audit fields, connection type, status, and secret reference without storing polling credentials'
type: task
status: not-started
epic: EPIC-12
release_gate: 'Gate 3'
depends_on: ['TASK-0206', 'TASK-0301']
unblocks: ['TASK-1202']
---

# TASK-1201: Implement `PowerMeter` and `PowerReading` entities, audit fields, connection type, status, and secret reference without storing polling credentials

## Objective

Implement `PowerMeter` and `PowerReading` entities, audit fields, connection type, status, and secret reference without storing polling credentials.
...
- EF tests verify schema and reject persisted plaintext credential fields.
