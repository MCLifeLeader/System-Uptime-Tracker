---
id: TASK-0607
title: 'Add SQL Server integration tests for reboot, restart, timeout, duplicate, concurrent, delayed, and clock-skew scenarios'
type: task
status: not-started
epic: EPIC-06
release_gate: 'Gate 1'
depends_on: ['TASK-0604', 'TASK-0605', 'TASK-0606']
unblocks: ['TASK-0608']
---

# TASK-0607: Add SQL Server integration tests for reboot, restart, timeout, duplicate, concurrent, delayed, and clock-skew scenarios

## Objective

Add SQL Server integration tests for reboot, restart, timeout, duplicate, concurrent, delayed, and clock-skew scenarios.
...
- Tests prove no overlapping active sessions and stable recomputation results.
