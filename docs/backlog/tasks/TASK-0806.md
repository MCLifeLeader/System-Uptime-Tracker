---
id: TASK-0806
title: 'Drain queued events in original per-agent sequence before or alongside live events without starving current collection'
type: task
status: not-started
epic: EPIC-08
release_gate: 'Gate 1'
depends_on: ['TASK-0707', 'TASK-0805']
unblocks: ['TASK-0807', 'TASK-0808', 'TASK-1304']
---

# TASK-0806: Drain queued events in original per-agent sequence before or alongside live events without starving current collection

## Objective

Drain queued events in original per-agent sequence before or alongside live events without starving current collection.
...
- [TASK-1304](./TASK-1304.md): Queue and publish normalized readings with their own message IDs and retry classification
...
- Recovery test uploads a backlog exactly once and preserves event ordering.
