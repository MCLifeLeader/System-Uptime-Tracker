...
- [TASK-0706](./TASK-0706.md): Implement bootstrap login, protected refresh-token storage, proactive access-token refresh, and disabled/revoked response handling
