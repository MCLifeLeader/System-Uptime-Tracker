---
id: TASK-1102
title: 'Implement CSRF protection for cookie-authenticated state changes and tightly scoped CORS when portal and API origins differ'
type: task
status: not-started
epic: EPIC-11
release_gate: 'Gate 1'
depends_on: ['TASK-1101']
unblocks: ['TASK-1108']
---

# TASK-1102: Implement CSRF protection for cookie-authenticated state changes and tightly scoped CORS when portal and API origins differ

## Objective

Implement CSRF protection for cookie-authenticated state changes and tightly scoped CORS when portal and API origins differ.
...
- Cross-origin and missing-antiforgery tests fail while valid same-site requests pass.
