---
id: TASK-0803
title: 'Enforce age and size caps with a deterministic oldest-first eviction policy and explicit data-loss metrics'
type: task
status: not-started
epic: EPIC-08
release_gate: 'Gate 1'
depends_on: ['TASK-0802']
unblocks: ['TASK-0805', 'TASK-0808']
---

# TASK-0803: Enforce age and size caps with a deterministic oldest-first eviction policy and explicit data-loss metrics

## Objective

Enforce age and size caps with a deterministic oldest-first eviction policy and explicit data-loss metrics.
...
- Boundary tests never exceed configured limits and report every eviction.
