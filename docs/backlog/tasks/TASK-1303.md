---
id: TASK-1303
title: 'Add optional independent Shelly polling schedules to agent core so disabled or failing power collection never blocks heartbeats'
type: task
status: not-started
epic: EPIC-13
release_gate: 'Gate 3'
depends_on: ['TASK-0707', 'TASK-1302']
unblocks: ['TASK-1304']
---

# TASK-1303: Add optional independent Shelly polling schedules to agent core so disabled or failing power collection never blocks heartbeats

## Objective

Add optional independent Shelly polling schedules to agent core so disabled or failing power collection never blocks heartbeats.
...
- Fault-injection test keeps heartbeats flowing during meter timeout and authentication failure.
