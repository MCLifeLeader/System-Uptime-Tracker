---
id: TASK-1105
title: 'Add heartbeat and runtime-session views with UTC/local-time clarity, current status text, and bounded date filters'
type: task
status: not-started
epic: EPIC-11
release_gate: 'Gate 1'
depends_on: ['TASK-0608', 'TASK-1104']
unblocks: ['TASK-1107']
---

# TASK-1105: Add heartbeat and runtime-session views with UTC/local-time clarity, current status text, and bounded date filters

## Objective

Add heartbeat and runtime-session views with UTC/local-time clarity, current status text, and bounded date filters.
...
- Status is not conveyed by color alone; table headers and filters have accessible names.
