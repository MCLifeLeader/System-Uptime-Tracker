---
id: TASK-0902
title: 'Configure self-contained single-file `win-x64` publishing without trimming and include non-secret configuration plus operator documentation'
type: task
status: not-started
epic: EPIC-09
release_gate: 'Gate 2'
depends_on: ['TASK-0901']
unblocks: ['TASK-0903']
---

# TASK-0902: Configure self-contained single-file `win-x64` publishing without trimming and include non-secret configuration plus operator documentation

## Objective

Configure self-contained single-file `win-x64` publishing without trimming and include non-secret configuration plus operator documentation.
...
- Artifact inspection finds the executable and every required support file.
