---
id: TASK-1502
title: 'Implement indexed read models or queries for uptime totals, session trends, meter energy, and location summaries with bounded date windows'
type: task
status: not-started
epic: EPIC-15
release_gate: 'Gate 4'
depends_on: ['TASK-1501']
unblocks: ['TASK-1503', 'TASK-1508']
---

# TASK-1502: Implement indexed read models or queries for uptime totals, session trends, meter energy, and location summaries with bounded date windows

## Objective

Implement indexed read models or queries for uptime totals, session trends, meter energy, and location summaries with bounded date windows.
...
- SQL integration tests verify correctness and query plans avoid unbounded scans for expected volumes.
