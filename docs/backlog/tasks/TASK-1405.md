---
id: TASK-1405
title: 'Define actionable metrics and alert thresholds for ingestion failure, auth failure, offline machines, queue age, migration failure, and inactive meters'
type: task
status: not-started
epic: EPIC-14
release_gate: 'Gate 3'
depends_on: ['TASK-0608', 'TASK-0808', 'TASK-1208', 'TASK-1402']
unblocks: ['TASK-1409', 'TASK-1508']
---

# TASK-1405: Define actionable metrics and alert thresholds for ingestion failure, auth failure, offline machines, queue age, migration failure, and inactive meters

## Objective

Define actionable metrics and alert thresholds for ingestion failure, auth failure, offline machines, queue age, migration failure, and inactive meters.
...
- [TASK-1508](./TASK-1508.md): Add optional alert evaluation for offline machines, stale meters, and queue/ingestion failures after alert destinations and noise budgets are approved
...
- Dashboard or query examples identify each injected failure during an operational exercise.
