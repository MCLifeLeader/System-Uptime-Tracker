---
id: TASK-1508
title: 'Add optional alert evaluation for offline machines, stale meters, and queue/ingestion failures after alert destinations and noise budgets are approved'
type: task
status: not-started
epic: EPIC-15
release_gate: 'Gate 4'
depends_on: ['TASK-1405', 'TASK-1502']
unblocks: ['TASK-1509']
---

# TASK-1508: Add optional alert evaluation for offline machines, stale meters, and queue/ingestion failures after alert destinations and noise budgets are approved

## Objective

Add optional alert evaluation for offline machines, stale meters, and queue/ingestion failures after alert destinations and noise budgets are approved.
...
- Synthetic events trigger once, recover cleanly, and do not expose private telemetry.
