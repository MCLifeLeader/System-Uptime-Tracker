---
id: TASK-0704
title: 'Implement Windows telemetry collection using least-privilege supported APIs and cancellation-aware asynchronous I/O'
type: task
status: not-started
epic: EPIC-07
release_gate: 'Gate 1'
...
# TASK-0704: Implement Windows telemetry collection using least-privilege supported APIs and cancellation-aware asynchronous I/O

## Objective

Implement Windows telemetry collection using least-privilege supported APIs and cancellation-aware asynchronous I/O.
...
- Tests or controlled probes cover unavailable counters and inaccessible volumes without terminating the worker.
