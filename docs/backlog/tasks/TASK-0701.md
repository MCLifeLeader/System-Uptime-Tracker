---
id: TASK-0701
title: 'Create `SystemUptimeTracker.Agent.Core` and its unit-test project with no Windows Service or systemd hosting dependency'
type: task
status: not-started
epic: EPIC-07
release_gate: 'Gate 1'
depends_on: ['TASK-0103', 'TASK-0202', 'TASK-0203']
unblocks: ['TASK-0702', 'TASK-0703', 'TASK-0801', 'TASK-1301']
---

# TASK-0701: Create `SystemUptimeTracker.Agent.Core` and its unit-test project with no Windows Service or systemd hosting dependency

## Objective

Create `SystemUptimeTracker.Agent.Core` and its unit-test project with no Windows Service or systemd hosting dependency.
...
- Project builds on Windows and Linux and exposes host-neutral interfaces.
