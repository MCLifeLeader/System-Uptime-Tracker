---
id: TASK-0805
title: 'Implement jittered bounded backoff, honor valid `Retry-After`, and prevent a poison item from blocking later eligible items'
type: task
status: not-started
epic: EPIC-08
release_gate: 'Gate 1'
depends_on: ['TASK-0803', 'TASK-0804']
unblocks: ['TASK-0806', 'TASK-0808']
---

# TASK-0805: Implement jittered bounded backoff, honor valid `Retry-After`, and prevent a poison item from blocking later eligible items

## Objective

Implement jittered bounded backoff, honor valid `Retry-After`, and prevent a poison item from blocking later eligible items.
...
- Virtual-time tests verify schedule, maximum delay, and queue progress.
