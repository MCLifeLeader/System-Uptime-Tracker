---
id: TASK-0301
title: 'Define the telemetry `DbContext` ownership and migration strategy alongside the existing Identity context'
type: task
status: not-started
epic: EPIC-03
release_gate: 'Gate 1'
depends_on: ['TASK-0107', 'TASK-0202', 'TASK-0203']
unblocks: ['TASK-0302', 'TASK-0402', 'TASK-0410', 'TASK-1201']
---

# TASK-0301: Define the telemetry `DbContext` ownership and migration strategy alongside the existing Identity context

## Objective

Define the telemetry `DbContext` ownership and migration strategy alongside the existing Identity context; explicitly choose one context or coordinated contexts.
...
- [TASK-0302](./TASK-0302.md): Implement `Machine`, `Heartbeat`, `StorageTelemetry`, and `RuntimeSession` entities with audit fields and domain-model nullability
...
- Define the telemetry `DbContext` ownership and migration strategy alongside the existing Identity context.
- Explicitly choose one context or coordinated contexts.
...
- Design-time migration creation and application work without starting the API.
