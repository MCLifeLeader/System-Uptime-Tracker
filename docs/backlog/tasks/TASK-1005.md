---
id: TASK-1005
title: 'Harden the unit with an unprivileged account, restricted writable paths, `NoNewPrivileges`, private temp, filesystem protection, restart policy, and network ordering'
type: task
status: not-started
epic: EPIC-10
release_gate: 'Gate 2'
depends_on: ['TASK-1004']
unblocks: ['TASK-1007']
---

# TASK-1005: Harden the unit with an unprivileged account, restricted writable paths, `NoNewPrivileges`, private temp, filesystem protection, restart policy, and network ordering

## Objective

Harden the unit with an unprivileged account, restricted writable paths, `NoNewPrivileges`, private temp, filesystem protection, restart policy, and network ordering.
...
- `systemd-analyze security` output is captured and documented exceptions are reviewed.
