---
id: TASK-1104
title: 'Build paginated machine inventory and detail views showing registration, last seen, OS, version, and assigned account'
type: task
status: not-started
epic: EPIC-11
release_gate: 'Gate 1'
depends_on: ['TASK-0505', 'TASK-1101']
unblocks: ['TASK-1105', 'TASK-1107']
---

# TASK-1104: Build paginated machine inventory and detail views showing registration, last seen, OS, version, and assigned account

## Objective

Build paginated machine inventory and detail views showing registration, last seen, OS, version, and assigned account.
...
- Empty, loading, error, unauthorized, and populated states have component and browser coverage.
