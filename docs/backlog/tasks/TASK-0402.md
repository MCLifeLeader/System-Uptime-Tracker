---
id: TASK-0402
title: 'Implement `DeviceAccount` as a domain companion to `ApplicationUser`, including owner, allowed methods, API-key metadata, active state, and audit fields'
type: task
status: not-started
epic: EPIC-04
release_gate: 'Gate 1'
depends_on: ['TASK-0301', 'TASK-0401']
unblocks: ['TASK-0403', 'TASK-0404', 'TASK-0405']
---

# TASK-0402: Implement `DeviceAccount` as a domain companion to `ApplicationUser`, including owner, allowed methods, API-key metadata, active state, and audit fields

## Objective

Implement `DeviceAccount` as a domain companion to `ApplicationUser`, including owner, allowed methods, API-key metadata, active state, and audit fields.
...
- Migration and model tests enforce one owner and one Identity user per device account.
