---
id: TASK-1309
title: 'Add accessible portal workflows for meter registration, reading history, locations, monitored devices, and association timelines'
type: task
status: not-started
epic: EPIC-13
release_gate: 'Gate 3'
depends_on: ['TASK-1107', 'TASK-1207', 'TASK-1307']
unblocks: ['TASK-1310']
---

# TASK-1309: Add accessible portal workflows for meter registration, reading history, locations, monitored devices, and association timelines

## Objective

Add accessible portal workflows for meter registration, reading history, locations, monitored devices, and association timelines.
...
- Browser tests complete independent meter creation and later association entirely through the API.
