---
id: TASK-0903
title: 'Implement `Install-SystemUptimeTrackerWindowsService.ps1` as an advanced, elevation-checked, parameter-validated, `SupportsShouldProcess` script using its own artifact directory'
type: task
status: not-started
epic: EPIC-09
release_gate: 'Gate 2'
depends_on: ['TASK-0902']
unblocks: ['TASK-0904']
---

# TASK-0903: Implement `Install-SystemUptimeTrackerWindowsService.ps1` as an advanced, elevation-checked, parameter-validated, `SupportsShouldProcess` script using its own artifact directory

## Objective

Implement `Install-SystemUptimeTrackerWindowsService.ps1` as an advanced, elevation-checked, parameter-validated, `SupportsShouldProcess` script using its own artifact directory.
...
- [TASK-0904](./TASK-0904.md): Stage immutable versioned releases under `Program Files`, keep durable state under `ProgramData`, and prevent source/application/data path overlap
...
- Pester tests cover invalid paths, missing elevation, `WhatIf`, and first install.
