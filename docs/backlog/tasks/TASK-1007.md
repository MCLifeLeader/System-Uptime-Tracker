---
id: TASK-1007
title: 'Add disposable Ubuntu lifecycle automation for install, repeat install, upgrade, rollback, reboot/autostart, restart recovery, stop, uninstall, and retained state'
type: task
status: not-started
epic: EPIC-10
release_gate: 'Gate 2'
depends_on: ['TASK-1004', 'TASK-1005', 'TASK-1006']
unblocks: ['TASK-1401', 'TASK-1404', 'TASK-1407']
---

# TASK-1007: Add disposable Ubuntu lifecycle automation for install, repeat install, upgrade, rollback, reboot/autostart, restart recovery, stop, uninstall, and retained state

## Objective

Add disposable Ubuntu lifecycle automation for install, repeat install, upgrade, rollback, reboot/autostart, restart recovery, stop, uninstall, and retained state.
...
- Gate 2 Linux job passes on the minimum supported Ubuntu release.
