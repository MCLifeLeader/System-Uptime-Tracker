---
id: TASK-1106
title: 'Normalize API Problem Details into actionable field and page errors'
type: task
status: not-started
epic: EPIC-11
release_gate: 'Gate 1'
depends_on: ['TASK-0208', 'TASK-1101']
unblocks: []
---

# TASK-1106: Normalize API Problem Details into actionable field and page errors

## Objective

Normalize API Problem Details into actionable field and page errors; focus the first invalid field and preserve user input.
...
- Normalize API Problem Details into actionable field and page errors.
- Focus the first invalid field and preserve user input.
...
- Unit and browser tests cover validation, conflict, forbidden, rate-limit, and unavailable states.
