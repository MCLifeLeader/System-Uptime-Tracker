---
id: TASK-0307
title: 'Add migration rollback/reapply and model-snapshot drift tests to CI'
type: task
status: not-started
epic: EPIC-03
release_gate: 'Gate 1'
depends_on: ['TASK-0306']
unblocks: ['TASK-1403', 'TASK-1408']
---

# TASK-0307: Add migration rollback/reapply and model-snapshot drift tests to CI

## Objective

Add migration rollback/reapply and model-snapshot drift tests to CI.
...
- CI creates a temporary database, migrates it, and detects an uncommitted model change.
