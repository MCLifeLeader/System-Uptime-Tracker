---
id: TASK-0905
title: 'Create or update the service with LocalService by default, automatic startup, description, restart-on-failure actions, and least-privilege ACLs'
type: task
status: not-started
epic: EPIC-09
release_gate: 'Gate 2'
depends_on: ['TASK-0904']
unblocks: ['TASK-0906']
---

# TASK-0905: Create or update the service with LocalService by default, automatic startup, description, restart-on-failure actions, and least-privilege ACLs

## Objective

Create or update the service with LocalService by default, automatic startup, description, restart-on-failure actions, and least-privilege ACLs.
...
- Installed service configuration and ACL assertions match `windows-service-reference.md`.
