---
id: TASK-1308
title: 'Validate that the reporting machine is authorized for the meter relationship while measured power remains owned by the meter'
type: task
status: not-started
epic: EPIC-13
release_gate: 'Gate 3'
depends_on: ['TASK-1304', 'TASK-1307']
unblocks: ['TASK-1310', 'TASK-1501']
---

# TASK-1308: Validate that the reporting machine is authorized for the meter relationship while measured power remains owned by the meter

## Objective

Validate that the reporting machine is authorized for the meter relationship while measured power remains owned by the meter.
...
- Collector-only data never appears as reporting-machine consumption; shared data is labeled aggregate.
