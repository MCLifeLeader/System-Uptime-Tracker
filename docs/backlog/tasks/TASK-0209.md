---
id: TASK-0209
title: 'Generate or maintain the API OpenAPI document and add a compatibility test for the accepted v1 surface'
type: task
status: not-started
epic: EPIC-02
release_gate: 'Gate 0'
depends_on: ['TASK-0202', 'TASK-0203', 'TASK-0204', 'TASK-0205', 'TASK-0206', 'TASK-0208']
unblocks: []
---

# TASK-0209: Generate or maintain the API OpenAPI document and add a compatibility test for the accepted v1 surface

## Objective

Generate or maintain the API OpenAPI document and add a compatibility test for the accepted v1 surface.
...
- CI detects accidental route, schema, required-field, or response-code changes.
