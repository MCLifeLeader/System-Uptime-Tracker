---
id: TASK-1107
title: 'Complete responsive keyboard, screen-reader semantics, visible focus, skip navigation, and contrast review for MVP routes'
type: task
status: not-started
epic: EPIC-11
release_gate: 'Gate 1'
depends_on: ['TASK-1103', 'TASK-1104', 'TASK-1105']
unblocks: ['TASK-1108', 'TASK-1309', 'TASK-1503']
---

# TASK-1107: Complete responsive keyboard, screen-reader semantics, visible focus, skip navigation, and contrast review for MVP routes

## Objective

Complete responsive keyboard, screen-reader semantics, visible focus, skip navigation, and contrast review for MVP routes.
...
- [TASK-1105](./TASK-1105.md): Add heartbeat and runtime-session views with UTC/local-time clarity, current status text, and bounded date filters

### Tasks Unblocked

- [TASK-1108](./TASK-1108.md): Add owner-login, device-account, machine, heartbeat, and session Playwright journeys to QA automation
- [TASK-1309](./TASK-1309.md): Add accessible portal workflows for meter registration, reading history, locations, monitored devices, and association timelines
- [TASK-1503](./TASK-1503.md): Add accessible portal reporting views and exports that preserve units, time-zone context, and measured/shared/estimated distinctions
...
- Automated accessibility checks pass and manual keyboard results are recorded.
