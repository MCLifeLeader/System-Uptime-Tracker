---
id: TASK-0802
title: 'Implement the selected local queue under the durable data root with single-process locking, crash-safe writes, and restrictive file permissions'
type: task
status: not-started
epic: EPIC-08
release_gate: 'Gate 1'
depends_on: ['TASK-0801']
unblocks: ['TASK-0803', 'TASK-0804']
---

# TASK-0802: Implement the selected local queue under the durable data root with single-process locking, crash-safe writes, and restrictive file permissions

## Objective

Implement the selected local queue under the durable data root with single-process locking, crash-safe writes, and restrictive file permissions.
...
- Process-termination test leaves the queue readable and internally consistent.
