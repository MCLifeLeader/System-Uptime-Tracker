---
id: TASK-1301
title: 'Create `SystemUptimeTracker.Power.Shelly` with a provider interface, bounded HTTP client, DTOs for supported Gen4 RPC responses, and normalized output'
type: task
status: not-started
epic: EPIC-13
release_gate: 'Gate 3'
depends_on: ['TASK-0701', 'TASK-1205']
unblocks: ['TASK-1302', 'TASK-1505']
---

# TASK-1301: Create `SystemUptimeTracker.Power.Shelly` with a provider interface, bounded HTTP client, DTOs for supported Gen4 RPC responses, and normalized output

## Objective

Create `SystemUptimeTracker.Power.Shelly` with a provider interface, bounded HTTP client, DTOs for supported Gen4 RPC responses, and normalized output.
...
- [TASK-1302](./TASK-1302.md): Load Shelly host and secret reference from validated configuration
...
- Fixture tests cover supported firmware payloads, missing components, authentication failure, timeout, and invalid JSON.
