---
id: TASK-0405
title: 'Implement cryptographically random API-key issuance, salted hashing, constant-time verification, one-time display, rotation, and revocation'
type: task
status: not-started
epic: EPIC-04
release_gate: 'Gate 1'
depends_on: ['TASK-0204', 'TASK-0402']
unblocks: ['TASK-0406', 'TASK-0407']
---

# TASK-0405: Implement cryptographically random API-key issuance, salted hashing, constant-time verification, one-time display, rotation, and revocation

## Objective

Implement cryptographically random API-key issuance, salted hashing, constant-time verification, one-time display, rotation, and revocation.
...
- Plaintext keys never appear in database rows or logs; old keys fail after rotation.
