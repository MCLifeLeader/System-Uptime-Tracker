---
id: TASK-0703
title: 'Define platform telemetry provider interfaces and normalized snapshots for OS, architecture, boot identity/time, CPU, memory, and storage'
type: task
status: not-started
epic: EPIC-07
release_gate: 'Gate 1'
depends_on: ['TASK-0701']
unblocks: ['TASK-0704', 'TASK-0705', 'TASK-0707']
---

# TASK-0703: Define platform telemetry provider interfaces and normalized snapshots for OS, architecture, boot identity/time, CPU, memory, and storage

## Objective

Define platform telemetry provider interfaces and normalized snapshots for OS, architecture, boot identity/time, CPU, memory, and storage.
...
- [TASK-0704](./TASK-0704.md): Implement Windows telemetry collection using least-privilege supported APIs and cancellation-aware asynchronous I/O
- [TASK-0705](./TASK-0705.md): Implement Ubuntu telemetry collection from stable OS interfaces with bounded reads and explicit parsing failures
...
- Contract mapping tests produce valid `TASK-0203` payloads.
