---
id: TASK-1302
title: 'Load Shelly host and secret reference from validated configuration'
type: task
status: not-started
epic: EPIC-13
release_gate: 'Gate 3'
depends_on: ['TASK-1301']
unblocks: ['TASK-1303']
---

# TASK-1302: Load Shelly host and secret reference from validated configuration

## Objective

Load Shelly host and secret reference from validated configuration; resolve credentials from protected storage and redact them from logs.
...
- Load Shelly host and secret reference from validated configuration.
- Resolve credentials from protected storage and redact them from logs.
...
- Configuration tests reject user-info URLs, unsupported schemes, invalid hosts, and unresolved secret references.
