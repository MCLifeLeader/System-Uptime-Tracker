---
id: TASK-1207
title: 'Add owner read endpoints for current meter state and paginated historical readings with deterministic time ordering'
type: task
status: not-started
epic: EPIC-12
release_gate: 'Gate 3'
depends_on: ['TASK-1204', 'TASK-1205']
unblocks: ['TASK-1208', 'TASK-1309', 'TASK-1501']
---

# TASK-1207: Add owner read endpoints for current meter state and paginated historical readings with deterministic time ordering

## Objective

Add owner read endpoints for current meter state and paginated historical readings with deterministic time ordering.
...
- Queries use bounded ranges and return no duplicated readings.
