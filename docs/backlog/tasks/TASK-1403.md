---
id: TASK-1403
title: 'Implement API, database, portal, and dependency liveness/readiness checks with startup grace and no sensitive detail for anonymous callers'
type: task
status: not-started
epic: EPIC-14
release_gate: 'Gate 3'
depends_on: ['TASK-0307', 'TASK-1109']
unblocks: ['TASK-1407']
---

# TASK-1403: Implement API, database, portal, and dependency liveness/readiness checks with startup grace and no sensitive detail for anonymous callers

## Objective

Implement API, database, portal, and dependency liveness/readiness checks with startup grace and no sensitive detail for anonymous callers.
...
- Orchestrator smoke tests distinguish alive, ready, degraded, and unavailable states.
