---
id: TASK-1203
title: 'Create and validate the power-foundation migration against empty and existing telemetry databases'
type: task
status: not-started
epic: EPIC-12
release_gate: 'Gate 3'
depends_on: ['TASK-1202']
unblocks: ['TASK-1204', 'TASK-1205', 'TASK-1305']
---

# TASK-1203: Create and validate the power-foundation migration against empty and existing telemetry databases

## Objective

Create and validate the power-foundation migration against empty and existing telemetry databases.
...
- [TASK-1202](./TASK-1202.md): Add unique meter identity constraints for vendor/external ID and optional MAC, plus reading idempotency and meter/time indexes
...
- [TASK-1305](./TASK-1305.md): Implement `Location`, `MonitoredDevice`, `MachinePowerMeterAssociation`, `PowerMeterDeviceAssociation`, and `PowerMeterLocationHistory` with effective dates
...
- Migration integration test upgrades without altering machine/session history.
