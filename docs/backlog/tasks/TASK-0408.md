---
id: TASK-0408
title: 'Require authentication on every non-health route and explicit owner/device policies by route group'
type: task
status: not-started
epic: EPIC-04
release_gate: 'Gate 1'
depends_on: ['TASK-0401', 'TASK-0406']
unblocks: ['TASK-0409', 'TASK-0502', 'TASK-1205', 'TASK-1307']
---

# TASK-0408: Require authentication on every non-health route and explicit owner/device policies by route group

## Objective

Require authentication on every non-health route and explicit owner/device policies by route group.
...
- [TASK-1307](./TASK-1307.md): Implement owner CRUD and end-association endpoints for locations, monitored devices, meter placement, machine reporting, and powered-device relationships
...
- A route inventory test fails when an endpoint lacks expected authorization metadata.
