---
id: TASK-0302
title: 'Implement `Machine`, `Heartbeat`, `StorageTelemetry`, and `RuntimeSession` entities with audit fields and domain-model nullability'
type: task
status: not-started
epic: EPIC-03
release_gate: 'Gate 1'
depends_on: ['TASK-0301']
unblocks: ['TASK-0303', 'TASK-0304', 'TASK-0305']
---

# TASK-0302: Implement `Machine`, `Heartbeat`, `StorageTelemetry`, and `RuntimeSession` entities with audit fields and domain-model nullability

## Objective

Implement `Machine`, `Heartbeat`, `StorageTelemetry`, and `RuntimeSession` entities with audit fields and domain-model nullability.
...
- EF model tests verify keys, required fields, column types, and relationships.
