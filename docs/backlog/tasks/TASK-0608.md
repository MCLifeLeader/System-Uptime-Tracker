---
id: TASK-0608
title: 'Expose owner-authorized current and historical session queries with pagination and deterministic ordering'
type: task
status: not-started
epic: EPIC-06
release_gate: 'Gate 1'
depends_on: ['TASK-0607']
unblocks: ['TASK-1105', 'TASK-1405', 'TASK-1501']
---

# TASK-0608: Expose owner-authorized current and historical session queries with pagination and deterministic ordering

## Objective

Expose owner-authorized current and historical session queries with pagination and deterministic ordering.
...
- API tests return running/offline state and historical sessions for only visible machines.
