---
id: TASK-1507
title: 'Implement discovered-machine and discovered-meter approval workflows only if deferred registration approval was selected'
type: task
status: not-started
epic: EPIC-15
release_gate: 'Gate 4'
depends_on: ['TASK-0001', 'TASK-1307']
unblocks: ['TASK-1509']
---

# TASK-1507: Implement discovered-machine and discovered-meter approval workflows only if deferred registration approval was selected

## Objective

Implement discovered-machine and discovered-meter approval workflows only if deferred registration approval was selected.
...
- Pending entities cannot submit or appear as active until an authorized owner approves them.
