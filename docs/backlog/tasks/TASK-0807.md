---
id: TASK-0807
title: 'Flush in-flight queue state on cancellation within a bounded shutdown period'
type: task
status: not-started
epic: EPIC-08
release_gate: 'Gate 1'
depends_on: ['TASK-0806']
unblocks: ['TASK-0901', 'TASK-1001']
---

# TASK-0807: Flush in-flight queue state on cancellation within a bounded shutdown period

## Objective

Flush in-flight queue state on cancellation within a bounded shutdown period.
...
- Forced service stop exits within the host timeout and loses no acknowledged local write.
