---
id: TASK-0407
title: 'Apply lockout and partitioned rate limits to password, token, refresh, and Basic Auth entry points without blocking health probes'
type: task
status: not-started
epic: EPIC-04
release_gate: 'Gate 1'
...
# TASK-0407: Apply lockout and partitioned rate limits to password, token, refresh, and Basic Auth entry points without blocking health probes

## Objective

Apply lockout and partitioned rate limits to password, token, refresh, and Basic Auth entry points without blocking health probes.
...
- Automated tests prove threshold behavior and recovery after the configured window.
