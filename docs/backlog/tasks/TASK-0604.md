---
id: TASK-0604
title: 'Implement timeout closure using a scheduled, restart-safe process and an injectable server clock'
type: task
status: not-started
epic: EPIC-06
release_gate: 'Gate 1'
...
# TASK-0604: Implement timeout closure using a scheduled, restart-safe process and an injectable server clock

## Objective

Implement timeout closure using a scheduled, restart-safe process and an injectable server clock.
...
- A stopped worker resumes safely and closes each expired session once.
