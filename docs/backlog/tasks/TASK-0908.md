---
id: TASK-0908
title: 'Implement uninstall that removes service registration and releases while retaining `ProgramData` unless an explicit confirmed purge is requested'
type: task
status: not-started
epic: EPIC-09
release_gate: 'Gate 2'
depends_on: ['TASK-0904', 'TASK-0906']
unblocks: ['TASK-0909']
---

# TASK-0908: Implement uninstall that removes service registration and releases while retaining `ProgramData` unless an explicit confirmed purge is requested

## Objective

Implement uninstall that removes service registration and releases while retaining `ProgramData` unless an explicit confirmed purge is requested.
...
- [TASK-0906](./TASK-0906.md): Replace fixed waits with bounded state polling
...
- Tests cover normal uninstall, purge, missing service, and rerun.
