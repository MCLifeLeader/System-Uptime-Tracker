---
id: TASK-0602
title: 'Implement the pure session-transition calculator using UTC instants and injected thresholds'
type: task
status: not-started
epic: EPIC-06
release_gate: 'Gate 1'
depends_on: ['TASK-0601']
unblocks: ['TASK-0603']
---

# TASK-0602: Implement the pure session-transition calculator using UTC instants and injected thresholds

## Objective

Implement the pure session-transition calculator using UTC instants and injected thresholds.
...
- Unit tests cover every decision-table row without database or clock dependencies.
