---
id: TASK-0308
title: 'Define retention boundaries for raw heartbeats, storage telemetry, sessions, and later power readings without implementing destructive defaults'
type: task
status: not-started
epic: EPIC-03
release_gate: 'Gate 1'
...
# TASK-0308: Define retention boundaries for raw heartbeats, storage telemetry, sessions, and later power readings without implementing destructive defaults

## Objective

Define retention boundaries for raw heartbeats, storage telemetry, sessions, and later power readings without implementing destructive defaults.
...
- Retention settings are documented and default to preserving data.
