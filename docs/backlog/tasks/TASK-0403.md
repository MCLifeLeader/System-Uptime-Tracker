---
id: TASK-0403
title: 'Implement owner-authorized create, list, update, disable, delete/reassign, and credential-rotation services with ownership checks'
type: task
status: not-started
epic: EPIC-04
release_gate: 'Gate 1'
depends_on: ['TASK-0402']
unblocks: ['TASK-0409', 'TASK-1103']
---

# TASK-0403: Implement owner-authorized create, list, update, disable, delete/reassign, and credential-rotation services with ownership checks

## Objective

Implement owner-authorized create, list, update, disable, delete/reassign, and credential-rotation services with ownership checks.
...
- Cross-owner access follows `TASK-0002`; disabling an account preserves machine and telemetry history.
