---
id: TASK-0606
title: 'Calculate `HeartbeatCount`, `LastHeartbeatAtUtc`, `EndedAtUtc`, and uptime duration with documented boundary semantics'
type: task
status: not-started
epic: EPIC-06
release_gate: 'Gate 1'
...
# TASK-0606: Calculate `HeartbeatCount`, `LastHeartbeatAtUtc`, `EndedAtUtc`, and uptime duration with documented boundary semantics

## Objective

Calculate `HeartbeatCount`, `LastHeartbeatAtUtc`, `EndedAtUtc`, and uptime duration with documented boundary semantics.
...
- Tests pin inclusive/exclusive threshold behavior and duration rounding.
