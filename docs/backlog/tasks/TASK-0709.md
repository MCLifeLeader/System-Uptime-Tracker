---
id: TASK-0709
title: 'Add lifecycle signals for agent start and graceful stop while leaving runtime sessions server-authoritative'
type: task
status: not-started
epic: EPIC-07
release_gate: 'Gate 1'
depends_on: ['TASK-0707', 'TASK-0708']
unblocks: ['TASK-0901', 'TASK-1001']
---

# TASK-0709: Add lifecycle signals for agent start and graceful stop while leaving runtime sessions server-authoritative

## Objective

Add lifecycle signals for agent start and graceful stop while leaving runtime sessions server-authoritative.
...
- [TASK-0901](./TASK-0901.md): Create the thin `SystemUptimeTracker.WindowsService` host and configure `AddWindowsService` with service name `SystemUptimeTrackerAgent`
- [TASK-1001](./TASK-1001.md): Create the thin `SystemUptimeTracker.LinuxDaemon` host with systemd integration and shared agent-core registration
...
- API integration test records lifecycle context without accepting a client-authored session.
