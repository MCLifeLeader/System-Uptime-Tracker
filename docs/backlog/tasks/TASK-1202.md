---
id: TASK-1202
title: 'Add unique meter identity constraints for vendor/external ID and optional MAC, plus reading idempotency and meter/time indexes'
type: task
status: not-started
epic: EPIC-12
release_gate: 'Gate 3'
depends_on: ['TASK-1201']
unblocks: ['TASK-1203']
---

# TASK-1202: Add unique meter identity constraints for vendor/external ID and optional MAC, plus reading idempotency and meter/time indexes

## Objective

Add unique meter identity constraints for vendor/external ID and optional MAC, plus reading idempotency and meter/time indexes.
...
- Duplicate registration and concurrent duplicate reading tests preserve one logical record.
